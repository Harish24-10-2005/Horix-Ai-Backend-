 ...
 */
export const handleListErrorEvents: ToolHandler = async (args, apiKey) => {
  const projectId = args.project_id;
  const errorId = args.error_id;
  const limit = args.limit || 10;

  const client = initApiClient(apiKey as string);
 ...
 */
export const handleViewLatestEvent: ToolHandler = async (args, apiKey) => {
  const errorId = args.error_id;
 ...
 */
export const handleViewEvent: ToolHandler = async (args, apiKey) => {
  const projectId = args.project_id;
 ...
 */
export const handleViewStacktrace: ToolHandler = async (args, apiKey) => {
  const projectId = args.project_id;
  const eventId = args.event_id;
 ...
 */
export const handleViewExceptionChain: ToolHandler = async (args, apiKey) => {
  const projectId = args.project_id;
  const eventId = args.event_id;
 ...
 */
export const handleViewTabs: ToolHandler = async (args, apiKey) => {
  const projectId = args.project_id;
  const eventId = args.event_id;
  const includeCode = args.include_code !== false; // Default to true
