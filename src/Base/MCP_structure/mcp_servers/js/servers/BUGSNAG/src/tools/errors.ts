 ...
 */
export const handleListErrors: ToolHandler = async (args, apiKey) => {
 ...
 */
export const handleViewError: ToolHandler = async (args, apiKey) => {
 ...
 */
export const handleSearchIssues: ToolHandler = async (args, apiKey) => {
  const projectId = args.project_id;
