...
def get_escalation_policies(
    *,
    ...
    __credentials__: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
    ...
    if policy_id is not None:
        ...
        return escalation_policies.show_escalation_policy(policy_id=policy_id,credentials=__credentials__)
    ...
    if current_user_context:
        ...
        user_context = users.build_user_context(credentials=__credentials__)
    ...
    return escalation_policies.list_escalation_policies(
        query=query, user_ids=user_ids, team_ids=team_ids, limit=limit,credentials=__credentials__
    )
...
def get_incidents(
    *,
    ...
    Args:
        ...
        __credentials__ (Dict[str, Any]): Optional credentials dictionary
    """
    ...
    *,
    ...
    if schedule_id is not None:
        ...
        return schedules.show_schedule(
            schedule_id=schedule_id, since=since, until=until,credentials=__credentials__
        )
    else:
        return schedules.list_schedules(query=query, limit=limit,credentials=__credentials__)


@mcp.tool()
def list_users_oncall(
    *, schedule_id: str, since: Optional[str] = None, until: Optional[str] = None,__credentials__: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
...
def get_services(
    *,
    ...
    if service_id is not None:
        ...
        return services.show_service(service_id=service_id,credentials=__credentials__)
    ...
    return services.list_services(team_ids=team_ids, query=query, limit=limit,credentials=__credentials__)
...
def get_teams(
    *,
    ...
    if team_id is not None:
        ...
        return teams.show_team(team_id=team_id,credentials=__credentials__)

    return teams.list_teams(query=query, limit=limit,credentials=__credentials__)
...
def get_users(
    *,
    ...
    if user_id is not None:
        ...
        return users.show_user(user_id=user_id,credentials=__credentials__)
...
@mcp.tool()
def build_user_context(*,__credentials__: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    The MCP server tools use this user context to filter the following resources:
        ...
        - Users
    """
    return users.build_user_context(credentials=__credentials__)
