...
def show_escalation_policy(*,credentials: Optional[Dict[str, Any]] = None, policy_id: str) -> Dict[str, Any]:
...
def fetch_escalation_policy_ids(*, credentials: Optional[Dict[str, Any]] = None,user_id: Optional[str] = None) -> List[str]:
    ...
    try:
        results = list_escalation_policies(user_ids=[user_id],credentials=credentials)
