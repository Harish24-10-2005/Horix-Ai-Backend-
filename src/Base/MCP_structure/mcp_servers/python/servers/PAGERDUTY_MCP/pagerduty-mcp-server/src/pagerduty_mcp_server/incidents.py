...
def list_incidents(
    *,
    ...
    """
    pd_client = create_client(credentials)
        ...
        if include_related_incidents:
            try:
                related_incidents_response = _list_related_incidents(
                    incident_id=incident_id,credentials = credentials
                )
...
def _list_past_incidents(
    *, incident_id: str, limit: Optional[int] = None, total: Optional[bool] = None,credentials: Optional[Dict[str, Any]] = None,
) -> Dict[str, Any]:
...
def _list_related_incidents(*, incident_id: str,credentials: Optional[Dict[str, Any]] = None,) -> Dict[str, Any]:
...
def _list_notes(*, incident_id: str,credentials: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
def _count_incident_statuses(incidents: List[Dict[str, Any]],credentials: Optional[Dict[str, Any]] = None) -> Dict[str, int]:
...
def _count_autoresolved_incidents(incidents: List[Dict[str, Any]],credentials: Optional[Dict[str, Any]] = None,) -> int:
