...
def list_schedules(
    *, query: Optional[str] = None, limit: Optional[int] = None,credentials: Optional[Dict[str, Any]] = None,
) -> Dict[str, Any]:
...
def show_schedule(
    *, schedule_id: str, since: Optional[str] = None, until: Optional[str] = None,credentials: Optional[Dict[str, Any]] = None,
) -> Dict[str, Any]:
