...
def show_service(*, service_id: str,credentials: Optional[Dict[str, Any]] = None,) -> Dict[str, Any]:
...
def fetch_service_ids(*, team_ids: List[str],credentials: Optional[Dict[str, Any]] = None,) -> List[str]:
