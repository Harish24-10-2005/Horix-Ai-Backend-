...
def parse_sub_dictionary(
    data: Optional[Dict[str, Any]], keys: List[str],credentials: Optional[Dict[str, Any]] = None
...
def parse_complex_item(
    item_data: Optional[Dict[str, Any]], principal_key: str, fields: List[str],credentials: Optional[Dict[str, Any]] = None,
) -> Optional[Dict[str, Any]]:
    """
...
def parse_list_of_items(
    ...
    item_parser_func: Callable[[Dict[str, Any]], Optional[Dict[str, Any]]],credentials: Optional[Dict[str, Any]] = None
